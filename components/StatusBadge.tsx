...
const PRODUCER_COLORS: Record<ProducerStatus, string> = {
  ...
  METADATA_SCORING: 'bg-accent-green/10 text-accent-green border-accent-green/30',
  METADATA_INSUFFICIENT_CLOSED: 'bg-ink-muted/15 text-ink-secondary border-ink-muted/40',
  FALSE_POSITIVE_CLOSED: 'bg-accent-blue/10 text-accent-blue border-accent-blue/40',
  EXPLORATORY_FINDING_READY: 'bg-accent-violet/15 text-accent-violet border-accent-violet/40',
